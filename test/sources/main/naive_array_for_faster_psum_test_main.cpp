...
void all_test(uint64_t seq_len, uint64_t alphabet_size, uint64_t number_of_trials, uint64_t seed, int message_paragraph = stool::Message::SHOW_MESSAGE){
    ...
    stool::DynamicIntegerTest<stool::NaiveIntegerArrayForFasterPsum<SIZE>, true, true> test;
    ...
    /*
    stool::DynamicIntegerTest::build_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed);
    stool::DynamicIntegerTest::psum_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed);
    stool::DynamicIntegerTest::search_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed);

    stool::DynamicIntegerTest::push_and_pop_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed, false);    
    stool::DynamicIntegerTest::insert_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed, false);
    stool::DynamicIntegerTest::remove_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed, false);
    stool::DynamicIntegerTest::replace_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed, false);
    stool::DynamicIntegerTest::random_test<stool::NaiveIntegerArray<SIZE>>(seq_len, alphabet_size, number_of_trials, seed, false);
    */

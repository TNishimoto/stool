...
void all_test(uint64_t seq_len, uint64_t alphabet_size, uint64_t number_of_trials, uint64_t seed, int message_paragraph = stool::Message::SHOW_MESSAGE){
    ...
    stool::DynamicIntegerTest<stool::EytzingerLayoutForPsum<SIZE>, true, true> test;
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char *argv[])
{
    ...
    [[maybe_unused]] uint64_t alphabet_size8 = UINT8_MAX;
    //uint64_t alphabet_size16 = UINT16_MAX;
    //uint64_t alphabet_size32 = UINT32_MAX;

    [[maybe_unused]]  uint64_t alphabet_size64 = (uint64_t)UINT32_MAX * 10000;

    
    
    //all_test<256>(101, alphabet_size8, number_of_trials, seed, stool::Message::SHOW_MESSAGE);

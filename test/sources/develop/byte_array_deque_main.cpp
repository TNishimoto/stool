...
{
    stool::ByteArrayDeque<uint16_t> deque;
...
int main([[maybe_unused]] int argc, [[maybe_unused]] char *argv[])
{
    ...
    access_test(seq_len, alphabet_size8, number_of_trials, seed);
    access_test(seq_len, alphabet_size16, number_of_trials, seed);
    access_test(seq_len, alphabet_size32, number_of_trials, seed);
    access_test(seq_len, alphabet_size64, number_of_trials, seed);

    replace_test(seq_len, alphabet_size8, number_of_trials, seed);
    replace_test(seq_len, alphabet_size16, number_of_trials, seed);
    replace_test(seq_len, alphabet_size32, number_of_trials, seed);
    replace_test(seq_len, alphabet_size64, number_of_trials, seed);

    push_and_pop_test(seq_len, alphabet_size8, number_of_trials, seed);
    push_and_pop_test(seq_len, alphabet_size16, number_of_trials, seed);
    push_and_pop_test(seq_len, alphabet_size32, number_of_trials, seed);
    push_and_pop_test(seq_len, alphabet_size64, number_of_trials, seed);

    insert_and_erase_test(seq_len, alphabet_size8, number_of_trials, seed);
    insert_and_erase_test(seq_len, alphabet_size16, number_of_trials, seed);
    insert_and_erase_test(seq_len, alphabet_size32, number_of_trials, seed);
    insert_and_erase_test(seq_len, alphabet_size64, number_of_trials, seed);

    psum_test(seq_len, alphabet_size8, number_of_trials, seed);
    psum_test(seq_len, alphabet_size16, number_of_trials, seed);
    psum_test(seq_len, alphabet_size32, number_of_trials, seed);
    psum_test(seq_len, alphabet_size64, number_of_trials, seed);
    

    search_test(seq_len, alphabet_size8, number_of_trials, seed);
    search_test(seq_len, alphabet_size16, number_of_trials, seed);
    search_test(seq_len, alphabet_size32, number_of_trials, seed);
    search_test(seq_len, alphabet_size64, number_of_trials, seed);
}

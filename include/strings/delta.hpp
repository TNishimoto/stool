...
namespace stool
{
    ...
    std::vector<uint64_t> construct_distinct_substring_counter_array(const std::vector<T> &text, const std::vector<uint64_t> &sa)
    {
    ...
    uint64_t compute_delta(std::vector<uint64_t> &distinct_substring_counter_array)
    {
    ...
    std::pair<stool::Rational, uint64_t> compute_detailed_delta(std::vector<uint64_t> &distinct_substring_counter_array)
    {
    ...
    std::vector<uint64_t> create_count_profile_array(const std::vector<uint64_t> &lcp_array)
    {
    ...
    std::vector<uint64_t> construct_distinct_substring_counter_array(const std::vector<uint64_t> &lcp_array)
    {
    ...
    void print_distinct_substring_counter_array(const std::vector<uint64_t> &lcp_array){
